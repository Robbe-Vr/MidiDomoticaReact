...
import { faClock, faGamepad, faImage, faList, faPhotoVideo, faUpload, faUsers } from "@fortawesome/free-solid-svg-icons";
            ...
            <div style={{ width: window.innerWidth, height: drawerHeight, display: 'block', overflow: 'hidden', position: 'absolute' }}>
                <div style={{ display: 'inline-block', width: window.innerWidth, overflow: 'hidden', verticalAlign: 'top', paddingTop: '10px', paddingBottom: '5px' }}>
                    <div style={{ height: drawerHeight - 2, overflow: 'hidden', marginLeft: '10px' }}>
                        <DrawerItem width={(window.innerWidth - 20) * 0.5} height={(drawerHeight - 22) * 0.5} icon={faList} link="/controls" text="Controls" />
                        <DrawerItem width={(window.innerWidth - 20) * 0.5} height={(drawerHeight - 22) * 0.5} icon={faClock} link="/timedevents" text="Timed Events" />
                        <DrawerItem width={(window.innerWidth - 20) * 0.5} height={(drawerHeight - 22) * 0.5} icon={faGamepad} link="/manual" text="Manual Control" />
                    </div>
                    : <></>
                </div>
            </div>
